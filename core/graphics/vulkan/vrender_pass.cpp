...
namespace oak::graphics {
	...
	VRenderPass::VRenderPass(const VDevice &device) : device_{ device }, renderPass_{ VK_NULL_HANDLE } {}

	VRenderPass::~VRenderPass() {
		destroy();
	}

	void VRenderPass::create(VkFormat colorFormat, VkFormat depthFormat) {
